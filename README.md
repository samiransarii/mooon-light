...
If something is broken installing with the recommended way, it is because [packagecontrol](https://packagecontrol.io) has not pulled the lates release yet,
So you can do it mannually by:
