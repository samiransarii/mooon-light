...
export default (scheme: Scheme) => ({
  ...
  globals: {
    ...
    invisibles: scheme.common.fg.alpha(0.3).hex(),
    caret: scheme.common.accent.hex(),
    block_caret: scheme.common.accent.alpha(0.3).hex(),
    ...
    inactive_selection_foreground: scheme.common.fg.alpha(0.3).hex(),
    selection_corner_style: "round",
    selection_corner_radius: "3",

    highlight: scheme.common.accent.alpha(0.4).hex(),
    ...
    stack_guide: scheme.ui.guide.normal.alpha(0.4).hex(),
  ...
  rules: [
    ...
    },
    {
      ...
      scope:
        "source.java meta.class.java meta.class.identifier.java storage.type.java",
      foreground: scheme.syntax.keyword.hex(),
    },
    ...
    // Types
    {
      name: "Types fixes",
      scope:
        "source.java storage.type, source.haskell storage.type, source.c storage.type",
...

    {
      name: "Entity name",
      scope:
        "entity.name, source.js meta.function-call.constructor variable.type",
      foreground: scheme.syntax.entity.hex(),
    },
